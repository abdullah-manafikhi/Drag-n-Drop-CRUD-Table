...
export const TableProvider = ({ children }) => {
    ...
    return (
        <TableContext.Provider value={{ cursor, setCursor, colors, setColors, adding, setAdding, addLine, setAddLine, items, setItems, style4, setStyle4, selectedLine, setSelectedLine, tableInfo, setTableInfo }}>
            {children}
